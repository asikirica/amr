...
#include "fvMeshTopoChangersRefiner2D.H"
...
{
    defineTypeNameAndDebug(refiner2D, 0);
    addToRunTimeSelectionTable(fvMeshTopoChanger, refiner2D, fvMesh);
}
}
...
Foam::label Foam::fvMeshTopoChangers::refiner2D::count
(
...
void Foam::fvMeshTopoChangers::refiner2D::calculateProtectedCells
(
...
void Foam::fvMeshTopoChangers::refiner2D::readDict()
{
...
Foam::fvMeshTopoChangers::refiner2D::refine
(
...
Foam::autoPtr<Foam::polyTopoChangeMap>
Foam::fvMeshTopoChangers::refiner2D::unrefine
(
...
Foam::word Foam::fvMeshTopoChangers::refiner2D::Uname
(
...
void Foam::fvMeshTopoChangers::refiner2D::refineFluxes
(
...
void Foam::fvMeshTopoChangers::refiner2D::refineUfs
(
    const labelHashSet& masterFaces,
    const polyTopoChangeMap& map
)
...
void Foam::fvMeshTopoChangers::refiner2D::unrefineFluxes
(
...
void Foam::fvMeshTopoChangers::refiner2D::unrefineUfs
(
    const Map<label>& faceToSplitPoint,
    const polyTopoChangeMap& map
)
...
const Foam::cellZone& Foam::fvMeshTopoChangers::refiner2D::findCellZone
(
...
void Foam::fvMeshTopoChangers::refiner2D::selectRefineCandidates
(
...
Foam::scalar Foam::fvMeshTopoChangers::refiner2D::selectRefineCandidates
(
    PackedBoolList& candidateCells,
...
Foam::labelList Foam::fvMeshTopoChangers::refiner2D::selectRefineCells
(
...
Foam::labelList Foam::fvMeshTopoChangers::refiner2D::selectUnrefinePoints
(
...
void Foam::fvMeshTopoChangers::refiner2D::extendMarkedCells
(
...
void Foam::fvMeshTopoChangers::refiner2D::checkEightAnchorPoints
(
...
Foam::fvMeshTopoChangers::refiner2D::refiner2D(fvMesh& mesh, const dictionary& dict)
:
...
Foam::fvMeshTopoChangers::refiner2D::~refiner2D()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::fvMeshTopoChangers::refiner2D::update()
{
...
void Foam::fvMeshTopoChangers::refiner2D::topoChange(const polyTopoChangeMap& map)
{
...
void Foam::fvMeshTopoChangers::refiner2D::mapMesh(const polyMeshMap& map)
{
...
void Foam::fvMeshTopoChangers::refiner2D::distribute
(
...
bool Foam::fvMeshTopoChangers::refiner2D::write(const bool write) const
{
