...
(
    ...
    DynamicList<refinementHistory4::splitCell4>& splitCells,
...
)
{
    ...
    refinementHistory4 refinementData
    (
        IOobject
        (
            "refinementHistory4",
            database.findInstance(polyMesh::meshSubDir, "refinementHistory4"),
            polyMesh::meshSubDir,
            database,
            IOobject::MUST_READ,
            IOobject::NO_WRITE,
    ...
    {
        refinementHistory4::splitCell4 splitCell = refinementData.splitCells()[i];
    ...
    forAll(timeDirs, timeI)
    {
        ...
        forAll(regionNames, regioni)
        {
...

            {
                ...
                if (!isFile(args.rootPath()/args.caseName()/"processor0"/runTime.timeName()/polyMesh::meshSubDir/"refinementHistory4"))
                {
                ...
                DynamicList<refinementHistory4::splitCell4> splitCells_;
